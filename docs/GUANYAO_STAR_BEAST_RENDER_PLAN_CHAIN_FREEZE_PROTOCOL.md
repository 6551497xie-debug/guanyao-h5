...
9. P50 Resolver 没有外部直接调用者；
10. 冻结链不包含 Renderer、UI、Runtime 或 Storage 实现；
11. P46 只导入 P47 Reference，P48–P50 不调用上游 Resolver；
12. freeze gate、P39–P50 gates、release、build 与 `git diff --check` 通过。
