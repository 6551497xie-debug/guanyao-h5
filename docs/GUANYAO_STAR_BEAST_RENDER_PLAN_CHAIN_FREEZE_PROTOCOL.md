...
7. P48 Resolver 没有外部直接调用者；
8. 冻结链不包含 Renderer、UI、Runtime 或 Storage 实现；
9. P46 只导入 P47 Reference，P48 不调用 P46/P47 Resolver；
10. freeze gate、P39–P48 gates、release、build 与 `git diff --check` 通过。
