...
|---|---|---|---|---:|
| POWER | DIRECT_AUTHORITY | CLIENT_PLATFORM | PUBLIC_EVALUATION | 3 |
| INTEREST | COMPENSATION | SHARED_HOUSEHOLD_RESOURCES | PARTNERSHIP_CONTRACT | 3 |
| RELATION | COMMUNICATION | TIME_ATTENTION | SHARED_DECISION_BOUNDARY | 3 |
| FAMILY | HOUSEHOLD_LABOR | MONEY_RESOURCES | MAJOR_DECISIONS | 3 |
| SOCIAL | COMMUNITY_GROUP | DIGITAL_SOCIAL_VISIBILITY | BELONGING_EXIT | 3 |
| EXISTENCE | TIME_STRUCTURE | BODY_ENERGY_ROUTINE | TRANSITION_DIRECTION | 3 |
