...
| Field | Mechanic | Context | Surface | Shell |
|---|---|---|---|---|
| POWER | RULE_OR_INFORMATION_GAP | TRANSITION_EXIT | 合作架构调整后，哪些事项仍由你确认没有写进新流程 | 旧请求和新请求同时找你 |
| POWER | POWER_OR_RESOURCE_ASYMMETRY | DIRECT_AUTHORITY | 职责被拆到两个团队，结果仍由你承担，关键权限却转走 | 同一交付要等外部批准 |
| POWER | BOUNDARY_OR_COMMITMENT_BREAK | PUBLIC_EVALUATION | 评审方答应按新职责说明标准，公布结果时仍沿用旧指标 | 新职责对应的分数仍是空白 |
...
| EXISTENCE | BOUNDARY_OR_COMMITMENT_BREAK | TRANSITION_DIRECTION | 原合作答应缩减固定时段，你转向独立创作后排班仍未减少 | 新作品没有完整制作日 |
