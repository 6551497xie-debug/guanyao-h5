...
const forceActionLines: Record<string, string[]> = {
  乾: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先把局面抓回手里。", "不是因为你真的稳，而是失控会让你觉得自己正在掉下去。"],
  坤: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先把别人托住。", "不是因为你不累，而是你太习惯把自己的需要往后放。"],
  震: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先动起来。", "不是因为你真的有方向，而是停下来会让问题变得太清楚。"],
  巽: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先观察风向。", "不是因为你没有立场，而是正面冲突会让你太快暴露自己。"],
  坎: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先沉下去。", "不是因为你真的冷静，而是把事情说出来会让危险变得太近。"],
  离: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先让自己看起来还亮着。", "不是因为你不累，而是暗下来会让你觉得自己快要消失。"],
  艮: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先停住。", "不是因为你真的冷静，而是往前一步会让问题变得太真实。"],
  兑: ["压力显影候选已锁定。", "母码驱动的反应很快：一遇到压力，你会先把关系稳住。", "不是因为你没有边界，而是冷场会让你害怕关系直接断掉。"],
};
