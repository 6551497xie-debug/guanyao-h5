...
} from "../components/RealityPressurePresentation";
  ...
  return (
    ...
    >
      ...
      {realityEntryConfirmed && !pressureObservationConfirmed ? (
        <RealityPressurePresentation
          pressureObservationConfirmed={pressureObservationConfirmed}
      ...
      {pressureObservationConfirmed && !gravityObservationConfirmed ? (
        <RealityGravityPresentation
          gravityObservationConfirmed={gravityObservationConfirmed}
          interactionAvailability={
            gravityExperienceUIRuntime?.interactionAvailability ?? "NONE"
          }
          choiceReadiness={
