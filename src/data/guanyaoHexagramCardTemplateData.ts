...
export const guanyaoHexagramCardTemplates: GuanyaoHexagramCardTemplate[] = [
  {
    ...
    referenceIds: ["001-qian-gaokong-reference-v1"],
    referenceStrategy: "仅作为 001 / 乾类上升承压参考，不作为 64 张卦码卡的全局模板；强调高位单点承压、支撑缺失、分力未发生。",
  ...
  },
  {
    ...
    referenceStrategy: "承载 / 地层 / 边界承受型，独立参考位 pending；不得使用 001 的中轴、高位、光柱或平台结构。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceIds: ["003-tun-potu-reference-v1"],
    referenceStrategy: "绑定 003 裂缝破土参考；适用于裂缝、破开、阻力中生长，不套用 001 高位承压模板。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceIds: ["004-meng-miwu-reference-pending-v1"],
    referenceStrategy: "迷雾遮蔽型 reference pending；不得绑定 001，核心是未明、遮蔽、看不清问题、认知未开。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceStrategy: "等待 / 水面阻隔 / 边界等待型；不得绑定 001，暂挂 boundary-structure，后续需补独立参考图。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    visualTopology: "boundary-structure",
    referenceIds: ["006-song-zhengming-reference-pending-v1"],
    referenceStrategy: "对峙边界型 reference pending；不得绑定 001，核心是对峙、分裂、边界、张力和立场显现。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceStrategy: "阵列归位 / 组织结构 / 力量回位型；不得绑定 001，暂挂 gathering-structure，后续需补独立参考图。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    visualTopology: "gathering-structure",
    referenceIds: ["gathering-structure-v1"],
    referenceStrategy: "中心靠近 / 关系连接 / 边界清楚后靠近型；不得绑定 001，暂挂 gathering-structure，后续需补独立参考图。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceIds: ["009-xiaoxu-miyun-reference-pending-v1"],
    referenceStrategy: "压顶蓄势型 reference pending；不得绑定 001，核心是压住未落、蓄势、云层压迫、临界未释放。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    visualTopology: "boundary-structure",
    referenceIds: ["010-lv-bingshang-reference-v1"],
    referenceStrategy: "绑定 010 窄径风险 / 黑冰边界参考；适用于窄路、风险路径、边界、谨慎推进，不套用 001 高位承压模板。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
