...
export const guanyaoHexagramCardTemplates: GuanyaoHexagramCardTemplate[] = [
  {
    ...
    referenceStrategy: "参考孤高上升 / 高位结构；避免祭坛、装置、光柱启动台；强调高位单点承压、支撑缺失、分力未发生。",
  ...
  },
  {
    ...
    referenceStrategy: "参考厚重地层 / 承载边界；避免深渊、峡谷、坠落；强调承载到边界。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceIds: ["thermal-crack-v1", "003-tun-potu-reference-v1"],
    referenceStrategy: "参考裂缝突破结构与 003 当前候选参考；核心是黑土裂缝中有力量向上顶出，仍保持无字底图规范。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceStrategy: "参考漂移迷雾结构；避免山水风景、仙气、水墨；核心是看得见边界但看不清路径。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceStrategy: "参考水面通道 / 阻隔结构；避免海景、月亮、浪漫等待；核心是水面通道未打开。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    visualTopology: "boundary-structure",
    referenceIds: ["boundary-structure-v1"],
    referenceStrategy: "参考对峙裂缝 / 边界结构；避免战争、法庭、人物争吵；核心是两股力量之间出现表达出口。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceStrategy: "参考阵列归位结构；避免金线网络、军队、旗帜、武器；核心是散掉的力量归入阵位。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    visualTopology: "gathering-structure",
    referenceIds: ["gathering-structure-v1"],
    referenceStrategy: "参考中心连接点；避免满屏关系网络；少量路径靠近中心但不融合，核心是靠近但不吞没。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    referenceStrategy: "参考压住未落结构；避免自然云海、荒原风景、山谷天光；核心是密云穹顶托住未落光。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
  ...
  },
  {
    ...
    visualTopology: "boundary-structure",
    referenceIds: ["boundary-structure-v1", "010-lv-bingshang-reference-v1"],
    referenceStrategy: "参考极窄路径 / 黑冰边界结构与 010 当前 B+ 候选参考；核心是黑色冰面上的谨慎路径，后续仍可替换。",
    referenceGenerationNote: "Use the assigned visual reference only for structure, negative space, light discipline, and abstraction level. Do not copy its content. Generate a new text-free visual for this hexagram.",
