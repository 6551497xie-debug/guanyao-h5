...
const matrixSeeds: Record<`${PressureSeedRuntimeAgeGroup}_${PressureSeedField}`, PressureSeedMatrixSeed[]> = {
  ...
  ESTABLISHING_EXISTENCE: [
    { id: "ESTABLISHING_EXISTENCE_01", pressureNature: "EVALUATION", surface: "生日那晚，你把毕业后定下的计划重新列了一遍。", shell: "计划还在，进度没有对齐。" },
    { id: "ESTABLISHING_EXISTENCE_02", pressureNature: "EVALUATION", surface: "你刷朋友圈，别人的生活都在往前。", shell: "比较压力让状态停住。" },
    { id: "ESTABLISHING_EXISTENCE_03", pressureNature: "SURVIVAL", surface: "连续几周早起后，你在通勤路上又睡过了站。", shell: "日程没有停，身体先慢了下来。" },
    { id: "ESTABLISHING_EXISTENCE_04", pressureNature: "EVALUATION", surface: "你翻到三年前写下的目标，完成的一栏仍然空着。", shell: "时间过去了，记录没有跟上。" },
    ...
    { id: "ESTABLISHING_EXISTENCE_09", pressureNature: "EVALUATION", surface: "你照镜子时，发现最近的状态和证件照差了很多。", shell: "状态发生了变化，原因还没有说清。" },
    { id: "ESTABLISHING_EXISTENCE_10", pressureNature: "EVALUATION", surface: "你问自己“现在好吗”，答不上来。", shell: "状态反馈暂时中断。" },
    { id: "ESTABLISHING_EXISTENCE_11", pressureNature: "CONTROL", surface: "你把每天排得很满，空下来的半小时却不知道做什么。", shell: "日程很满，方向仍然空着。" },
    ...
    { id: "ESTABLISHING_EXISTENCE_14", pressureNature: "OBLIGATION", surface: "工作、租房和家里的临时事情排在了同一周。", shell: "多条责任同时占住了日程。" },
