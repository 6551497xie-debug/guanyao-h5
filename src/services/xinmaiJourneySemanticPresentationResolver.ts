...
const COPY: Readonly<Record<XinmaiJourneySemanticNodeId, Copy>> = Object.freeze({
  ...
  GENESIS_FORMATION: c("星图正在校准它的位置", "它并非此刻被创造；这个坐标只让你第一次看见它。", "继续寻找", "稍后再来", "定位完成后，你可以主动认出这个生命。", "星宿与星河让远方生命逐渐可见"),
  STAR_BEAST_CONTINUITY: c("你们已经彼此看见", "接下来，做一次很小的回应，确认这段同行从你们双方开始。", "继续相遇", "先离开", "回应完成后，你可以确认同行并一起进入现实。", "两个生命在同一片星图中完成第一次交换"),
  WHISPER: c("想让它先听见什么？", "可以留一个词，也可以选择安静；它只用光回应，不分析这句话。", "让它听见", "先安静地相遇", "它的回应完成后，这次相遇才会被确认。", "用户表达与星兽回应形成第一次交换"),
