...
export function resolveDynamicsCurrentCrystalPresentation(
  ...
  return {
    ...
    cardJourneyCopy: `这一局从【${motherName}】进入【${hexagramTitle}】。经过你的回应和变化，它留下了一枚生命印记。`,
    cardPrivacyCopy: "看看这一局留下的生命印记。它只保留这次变化，不暴露具体压力原句。",
    behaviorReading: [
      "这枚生命印记不记录你的压力原句。",
      `它留下的是【${motherName}】这份原始生命倾向，在「${hexagramTitle}」这一局中与现实相遇后发生的变化。`,
