...
const GRAMMARS: Readonly<Record<SixSpaceId, XinmaiSixDimensionSemanticGrammar>> =
  Object.freeze({
    ...
    thought: Object.freeze({
      dimensionId: "thought", label: "思维", question: "这件事发生时，脑中最先出现哪句话或片段？",
      responses: Object.freeze([
    ...
    action: Object.freeze({
      dimensionId: "action", label: "行动", question: "你最先想做的是推进、退开，还是先停一下？",
      responses: Object.freeze([
    ...
    memory: Object.freeze({
      dimensionId: "memory", label: "记忆", question: "此刻像不像某个熟悉的时刻？",
      responses: Object.freeze([
    ...
    goal: Object.freeze({
      dimensionId: "goal", label: "动机", question: "这份反应最不想失去的，是什么？",
      responses: Object.freeze([
      ...
      ]), acknowledgementLabel: "保存这次动机观察", spatialMode: "GOAL_CORE",
    }),
  });
