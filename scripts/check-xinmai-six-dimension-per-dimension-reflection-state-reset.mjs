...
assert(page.slice(page.indexOf("function continueObservation()"), page.indexOf("function handleLifeCoreApproach()")).includes("if (!innerViewRelationEstablished) return false;") && page.includes("return onNodeBloom();"), "final explicit continuation is not the sole item commit path");
