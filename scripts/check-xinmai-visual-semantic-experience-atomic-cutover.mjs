...
assert(checkpoint.includes("notAttemptedSemantic") && checkpoint.includes("rejectedRecordSemantic") && journeySemantic.includes("先回到生活") && journeySemantic.includes("返回重新选择") && journeySemantic.includes("确认不记录，返回旅程入口"), "checkpoint branches do not expose complete actions");
